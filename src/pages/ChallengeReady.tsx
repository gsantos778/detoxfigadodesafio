        ...
        <div className="text-center mt-4 sm:mt-6">
          ...
          {discountApplied && <div className="animate-bounce-in">
              <div className="max-w-xs sm:max-w-sm mx-auto px-2">
                ...
                <button className="relative bg-[#0ea06b] hover:bg-[#0a6b48] text-white font-bold px-6 sm:px-8 py-3 sm:py-4 rounded-full text-lg sm:text-xl shadow-[0_8px_20px_rgba(14,160,107,0.4)] transition-all duration-300 cursor-pointer overflow-hidden animate-button-pulse w-full" onClick={() => window.open('https://www.ggcheckout.com/checkout/v2/wM0Jm2q1JwtXxthnmV7e', '_blank')}>
