  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center px-3 md:px-4 pt-6 md:pt-8">
        {/* Title */}
        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-center text-gray-800 mb-6 md:mb-8 max-w-md leading-tight px-2">
          Um plano de emagrecimento de {weeksNeeded} semanas pode causar um impacto duradouro!
        </h1>

        {/* Animated Chart */}
        <div className="w-full max-w-md bg-[#e8f4f0] rounded-xl md:rounded-2xl p-4 md:p-6 mb-6 md:mb-8">
        ...
        <Button
          ...
          className="w-full max-w-md py-5 md:py-6 text-base md:text-lg font-semibold rounded-full"
        >
          Próximo
        </Button>
      </main>
